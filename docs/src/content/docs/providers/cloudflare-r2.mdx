...
Log into the [Cloudflare dashboard](https://dash.cloudflare.com/), if you have more than one account select the one you will be accessing.

1. From the selected Cloudflare account, open R2 Object Storage on the side bar.


![docs/providers/cf-r2.png](https://images.azydeco.com/docs/providers/cf-r2.png )

2. Click on the Create bucket button

3. give your bucket a name, set a location for the bucket if you need to,

4. Click Create bucket. The bucket should now be listed on the page. From here you will need to create an API token to get the values you can input into the extension to see the contents of your bucket.

![docs/providers/cf-r2-2.png](https://images.azydeco.com/docs/providers/cf-r2-2.png )
...
![docs/providers/cf-r2-3.png](https://images.azydeco.com/docs/providers/cf-r2-3.png )
...
If you will be uploading images make sure you select `Object Read & Write`

![docs/providers/cf-r2-4.png](https://images.azydeco.com/docs/providers/cf-r2-4.png )
...
![docs/providers/cf-r2-5.png](https://images.azydeco.com/docs/providers/cf-r2-5.png )
