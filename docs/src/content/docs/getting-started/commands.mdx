...
## Show Image Storage Panel

```
>Image Storage Explorer: Show Image Storage Panel
```
Opens the main panel in vscode's Editor.

## Show InfoPanel
```
>Image Storage Explorer: Show InfoPanel
```
...
```
>Image Storage Explorer: Allow Information Messages
```

Allows popup information messages to be shown again if you had previously clicked Do Not Show Again on a message.