...
If you are adding a bucket that is containing more than 5000 objects it is recommended that you use the `Prefix` option when creating the Storage Provider, otherwise you might find your loading times to be slow.
